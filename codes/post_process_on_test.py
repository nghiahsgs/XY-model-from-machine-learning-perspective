'''
this file help create calc basic information of test data
(we will use this info to plot data or observe)
input:
    type=args[1] #vortex
    data_dir=args[2] 
    model_dir=args[3]
output: 
    ...
    xy,angle,vortex, label,temp,angle_vortex,helicity,mag,predict_32,predict_softmax
'''
import sys
import numpy as np
